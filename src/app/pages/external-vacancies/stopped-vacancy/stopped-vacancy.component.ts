...
@Component({
  selector: 'vex-stopped-vacancy',
  templateUrl: './stopped-vacancy.component.html',
  styleUrls: ['./stopped-vacancy.component.scss', './stopped-vacancy.component.css']
})
export class StoppedVacancyComponent implements OnInit, AfterViewInit {
